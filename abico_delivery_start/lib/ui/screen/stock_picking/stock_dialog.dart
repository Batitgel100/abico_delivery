...
//   const StockPickingDialog({super.key, required this.note});

//   @override
//   State<StockPickingDialog> createState() => _StockPickingDialogState();
// }
...
//                   height: 10,
//                 ),
//                 Text('Бэлдэх тоо ${widget.note.qtyDone}'),
//                 Text('Бэлдсэн тоо ${widget.note.qtyDone}'),
//                 Row(
